...
**Important**: The bit-shifted expression should be unsigned. On some MCUs, "signed right-shift" is implemeted by an "arithmetic shift right" that duplicated the sign bit: ``0b1010 >> 1 = 0b1101``.
