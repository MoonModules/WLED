...
- Document attribution of inspiration / knowledge / sources used in the code, e.g. GitHub repositories or other websites describing the principles / algorithms used.
